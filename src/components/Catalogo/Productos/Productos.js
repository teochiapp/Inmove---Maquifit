...
const Productos = () => {
  const { categorias, loading: categoriasLoading } =
    useCategoriasWithFallback();
  const {
  ...
  return (
    <ProductosSection id="productos-section">
      <Container>
        {categorias.map((categoria, index) => {
          const categoriaSlug = categoria.slug;
          const productosDeCategoria =
            productosByCategoria[categoriaSlug]?.productos || [];
          ...
          return (
            ...
            >
              ...
              <CarruselContainer>
                ...
                <ProductosCarrusel
                  data-carrusel
                  $mostrarScroll={mostrarBotones}
                  $mostrarCarruselMobile={mostrarCarruselMobile}
                >
...
const CarruselButton = styled.button`
  ...
  &:hover {
    ...
    svg {
      transform: ${(props) =>
        props.$position === "left" ? "translateX(-3px)" : "translateX(3px)"};
    }
  }
  ...
  &:active {
    ...
    svg {
      transform: ${(props) =>
        props.$position === "left" ? "translateX(-1px)" : "translateX(1px)"};
    }
  }
  ...
  @media (max-width: 1200px) {
    ${(props) =>
      props.$position === "left" ? "left: -15px;" : "right: -15px;"}
    width: 45px;
    height: 45px;
